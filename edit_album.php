...
<body>
	...
	<div class="jumbotron">
        <div id="container">
        <p>Click to edit the album information</p>
			<?php
			...
			<div class='view_box'>
				...
				?>
				<a class="btnEdit_album">
				<img id="<?php echo $album_id; ?>" src='<?php echo $src_img; ?>' height=180 alt="No picture for present." />
				<br/>
